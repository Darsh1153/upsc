...
// Icons use Tabler icon names for consistent styling
...
export const PAPER_CATEGORIES = [
  { id: 'GS1', name: 'GS Paper 1', subtitle: 'History, Geography, Culture', color: '#FF6B6B', icon: 'IconBook' },
  { id: 'GS2', name: 'GS Paper 2', subtitle: 'Polity, Governance, IR', color: '#4ECDC4', icon: 'IconScale' },
  { id: 'GS3', name: 'GS Paper 3', subtitle: 'Economy, Environment, S&T', color: '#45B7D1', icon: 'IconCurrencyDollar' },
  { id: 'GS4', name: 'GS Paper 4', subtitle: 'Ethics & Aptitude', color: '#96CEB4', icon: 'IconCompass' },
  { id: 'Current Affairs', name: 'Current Affairs', subtitle: 'Daily & Monthly', color: '#FF9F43', icon: 'IconNews' },
  { id: 'Essay', name: 'Essay', subtitle: 'Writing Practice', color: '#A55EEA', icon: 'IconPencil' },
  { id: 'Optional', name: 'Optional Subject', subtitle: 'Your chosen subject', color: '#778CA3', icon: 'IconBookOpen' },
];
